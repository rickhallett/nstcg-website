...
async function createGamificationProfile(email, userId, referralCode) {
  try {
    const properties = {
      ...
      'Direct Referrals': { number: 0 },
      'Indirect Referrals': { number: 0 },
      'Twitter Shares': { number: 0 },
      'Facebook Shares': { number: 0 },
      'WhatsApp Shares': { number: 0 },
      'LinkedIn Shares': { number: 0 },
      'Email Shares': { number: 0 },
      'Daily Twitter Shares': { number: 0 },
      'Daily Facebook Shares': { number: 0 },
      'Daily WhatsApp Shares': { number: 0 },
      'Daily LinkedIn Shares': { number: 0 },
      'Daily Email Shares': { number: 0 },
